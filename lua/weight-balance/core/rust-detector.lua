...
-- Caché por buffer para almacenar la firma de las importaciones de Rust y evitar ejecuciones redundantes
local buffer_cache = {}
...
function M.check_rust_dependencies(callback, bufnr)
    bufnr = bufnr or 0

    local script_path = search_parser("rust")
